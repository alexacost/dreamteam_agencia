    ...
    foreach ($conn->query($sql) as $row) { ?>
        ...
        ?>
            ...
            <div class="col-md-6">
                ...
                <p><span class="mr-1"><strong>$ 10.000</strong></span></p>
                <p class="pt-1">Dragon Ball Z: Kakarot es un videojuego de rol de acción, desarrollado por CyberConnect2
                    y publicado por Bandai Namco Entertainment.</p>
            </div>
            <div class="row mx-1 mt-5 ">
                <h2 class="mb-4">Deja tu comentario</h2>
                <div class="md-form md-outline">
                    <textarea id="form76" class="md-textarea form-control form-control-coment" rows="4" width="50%"></textarea>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5 col-md-6 col-12 pb-4 comentario">
                    <h4>Jhon Doe</h4> <span class="producto_titulo">28 de Noviembre, 2021</span> <br>
